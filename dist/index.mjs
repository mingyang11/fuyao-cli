...
${indent}`);
  ...
  formatError(err, opts) {
    var _a8;
    const message = (_a8 = err.message) != null ? _a8 : formatWithOptions(opts, err);
...
var i = (e) => {
  var _a8, _b5;
  return ((_a8 = globalThis.process) == null ? void 0 : _a8.env) || import_meta.env || ((_b5 = globalThis.Deno) == null ? void 0 : _b5.env.toObject()) || globalThis.__env__ || (e ? r : globalThis);
};
var o = new Proxy(r, { get(e, s2) {
  var _a8;
  return (_a8 = i()[s2]) != null ? _a8 : r[s2];
}, has(e, s2) {
  const E = i();
...
function b() {
  ...
  if ((_a8 = globalThis.process) == null ? void 0 : _a8.env) for (const e of f) {
    const s2 = e[1] || e[0];
    if ((_b5 = globalThis.process) == null ? void 0 : _b5.env[s2]) return __spreadValues({ name: e[0].toLowerCase() }, e[2]);
  }
...
function createConsola2(options = {}) {
  ...
  const consola2 = createConsola(__spreadValues({
    ...
    prompt: (...args) => import("./prompt-HATQRYWB.mjs").then((m) => m.prompt(...args)),
    reporters: options.reporters || [
      ((_b5 = options.fancy) != null ? _b5 : !(T || R)) ? new FancyReporter() : new BasicReporter()
    ]
  }, options));
  return consola2;
}
