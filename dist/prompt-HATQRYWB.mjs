...
var FD = O(uD);
function A$1(t, u2 = {}) {
  if (typeof t != "string" || t.length === 0 || (u2 = __spreadValues({ ambiguousIsNarrow: true }, u2), t = T$1(t), t.length === 0)) return 0;
  t = t.replace(FD(), "  ");
...
var x = class {
  constructor(u2, F2 = true) {
    ...
    const _a = u2, { input: e2 = stdin, output: s = stdout, render: i, signal: D } = _a, C2 = __objRest(_a, ["input", "output", "render", "signal"]);
  ...
  setSubscriber(u2, F2) {
    var _a;
    const e2 = (_a = this._subscribers.get(u2)) != null ? _a : [];
  ...
  emit(u2, ...F2) {
    var _a;
    const e2 = (_a = this._subscribers.get(u2)) != null ? _a : [], s = [];
  ...
  prompt() {
    return new Promise((u2, F2) => {
      ...
      e2._write = (s, i, D) => {
        var _a, _b, _c;
        this._track && (this.value = (_a = this.rl) == null ? void 0 : _a.line.replace(/\t/g, ""), this._cursor = (_c = (_b = this.rl) == null ? void 0 : _b.cursor) != null ? _c : 0, this.emit("value", this.value)), D();
  ...
  onKeypress(u2, F2) {
    ...
    k$1([u2, F2 == null ? void 0 : F2.name, F2 == null ? void 0 : F2.sequence], "cancel") && (this.state = "cancel"), (this.state === "submit" || this.state === "cancel") && this.emit("finalize"), this.render(), (this.state === "submit" || this.state === "cancel") && this.close();
  }
  close() {
    var _a;
    this.input.unpipe(), this.input.removeListener("keypress", this.onKeypress), this.output.write(`
`), d$1(this.input, false), (_a = this.rl) == null ? void 0 : _a.close(), this.rl = void 0, this.emit(`${this.state}`, this.value), this.unsubscribe();
  }
  restoreCursor() {
...
`).length - 1;
  ...
  render() {
    var _a;
    const u2 = G((_a = this._render(this)) != null ? _a : "", process.stdout.columns, { hard: true });
...
var wD = class extends x {
  constructor(u2) {
    var _a;
    super(u2, false), Y(this, "options"), Y(this, "cursor", 0), this.options = u2.options, this.value = [...(_a = u2.initialValues) != null ? _a : []], this.cursor = Math.max(this.options.findIndex(({ value: F2 }) => F2 === u2.cursorAt), 0), this.on("key", (F2) => {
      F2 === "a" && this.toggleAll();
    }), this.on("cursor", (F2) => {
      switch (F2) {
        case "left":
...
var B = (t) => {
  var _a;
  const { cursor: n, options: s, style: r2 } = t, i = (_a = t.maxItems) != null ? _a : Number.POSITIVE_INFINITY, a = Math.max(process.stdout.rows - 4, 0), c2 = Math.min(a, Math.max(i, 5));
  let l = 0;
...
`;
    ...
    case "cancel":
      return `${n}${e.gray(o)} ${e.strikethrough(e.dim((_a = this.value) != null ? _a : ""))}${((_b = this.value) == null ? void 0 : _b.trim()) ? `
${e.gray(o)}` : ""}`;
    default:
...
var ye = (t) => {
  var _a, _b, _c;
  const n = (_a = t.active) != null ? _a : "Yes", s = (_b = t.inactive) != null ? _b : "No";
  return new fD({ active: n, inactive: s, initialValue: (_c = t.initialValue) != null ? _c : true, render() {
    const r2 = `${e.gray(o)}
${w(this.state)} ${t.message}
`, i = this.value ? n : s;
    switch (this.state) {
...
var ve = (t) => {
  const n = (s, r2) => {
    var _a;
    const i = (_a = s.label) != null ? _a : String(s.value);
    switch (r2) {
      case "selected":
        return `${e.dim(i)}`;
      case "active":
...
var fe = (t) => {
  ...
  const n = (s, r2) => {
    var _a2;
    const i = (_a2 = s.label) != null ? _a2 : String(s.value);
  ...
  return new wD({ options: t.options, initialValues: t.initialValues, required: (_a = t.required) != null ? _a : true, cursorAt: t.cursorAt, validate(s) {
  ...
  return __async(this, arguments, function* (message, opts = {}) {
    const handleCancel = (value) => {
      ...
      switch (opts.cancel) {
        ...
        default:
        case "default": {
          return (_a = opts.default) != null ? _a : opts.initial;
        }
      }
    };
